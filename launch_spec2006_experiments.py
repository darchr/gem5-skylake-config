            ...
            for size in benchmark_sizes[cpu]:
                ...
                for benchmark in benchmarks:
                    run = gem5Run.createFSRun(
                        f'SPEC_2006_test_{cpu}_{size}_{mem}_{benchmark}',
                        binary_gem5, # gem5_binary
                        'gem5-configs/run-spec.py', # run_script
                        f'results/gem5v20.1.0.0/{cpu}/{size}/{mem}/{benchmark}', # relative_outdir
